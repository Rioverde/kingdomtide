...
var temperatureOpts = noise.OctaveOpts{
	Octaves:     2,
	Lacunarity:  2.0,
	Persistence: 0.5,
	Scale:       80.0,
...
var moistureOpts = noise.OctaveOpts{
	Octaves:     3,
	Lacunarity:  2.0,
	Persistence: 0.5,
	Scale:       64.0,
...
var continentOpts = noise.OctaveOpts{
	Octaves:     3,
	Lacunarity:  2.0,
	Persistence: 0.5,
	Scale:       512.0,
...
var ridgeOpts = noise.OctaveOpts{
	Octaves:     3,
	Lacunarity:  2.0,
	Persistence: 0.5,
...
type WorldGenerator struct {
	seed             int64
	elevation        noise.OctaveNoise
	temperature      noise.OctaveNoise
	moisture         noise.OctaveNoise
	continent        noise.OctaveNoise
...
func NewWorldGenerator(seed int64) *WorldGenerator {
	...
	return &WorldGenerator{
		...
		moisture:         noise.NewOctaveNoise(seed^seedSaltMoisture, moistureOpts),
...
func (g *WorldGenerator) Chunk(cc chunk.ChunkCoord) chunk.Chunk {
